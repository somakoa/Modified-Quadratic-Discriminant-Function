      SUBROUTINE FILTM4(IA,I1,J1,IB)
***
CS    CALL FILTM4(IA,I1,J1,IB)
***
CP    GAZOU DATA NI 4 KINBOU NI YORU HEIKINCHI FILTER O KAKERU
***
...
***
      INTEGER IA(I1,J1),IB(I1,J1)
***
CF    FILTER O KAKERU
***
      DO 10 J=2,J1-1
      DO 10 I=2,I1-1
        IB(I,J)=NINT((           IA(I,J-1)
