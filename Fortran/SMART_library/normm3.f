      SUBROUTINE NORMM3(IA,I1,J1,IB,I2,J2,IT,ILL)
CS    CALL NORMM3(IA,I1,J1,IB,I2,J2,IT,ILL)
C
CP** GYUSIN 4-BUNKATSU SEIKIKA (GYUSIN WO FRAME NO TYUSIN TO SURU) ***
CP**  4-RYOUIKI DE SINSYUKU-HI WO KAETE ICHI OOKISA NO SEIKIKA WO SURU
C
CA I  IA(I1,J1): NYUURYOKU TACHI GAZOU        I
CA I   I1:IA NO DAIICHI SEIGOU SUNPOU         I
CA I   J1:IA NO DAINI SEIGOU SUNPOU           I
CA O  IB(I2,J2) : SYUTSURYOKU TACHI GAZOU     I
CA I   I2:IB NO DAIICHI SEIGOU SUNPOU         I
CA I   J2:IB NO DAINI SEIGOU SUNPOU           I
CA I  IT:SIKIICHI                             I
CA I   ILL:ERROR CODE(0:NORMAL)               I
...
C***    MOJI NO GAISETSU WAKU WO MOTOMERU         ***
      CALL NSIZEM(IA,I1,J1,IL,IR,JT,JB,IT,ILL)
      IF(ILL.NE.0) RETURN
CT    WRITE(6,*)' IL,IR,JT,JB : ',IL,IR,JT,JB
C***    MOJI NO GYUUSIN WO MOTOMERU               ***
      CALL GCENTM(IA,I1,J1,IGX,IGY,SVX,SVY,IT,ILL)
      IF(ILL.NE.0) RETURN
