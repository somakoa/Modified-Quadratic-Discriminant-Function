      SUBROUTINE FLTM8D(IA,I1,J1,IS,JS,IB)
***
CS    CALL FLTM8D(IA,I1,J1,IS,JS,IB)
***
...
CD    REVISED  BY  T.WAKA    1996.06.19
***
...
***
      DO 10 J=2,J1-1
          DO 10 I=2,I1-1
              IB(I,J)=IA(I-1,J-1)+IA(I,J-1)+IA(I+1,J-1)
     @             +IA(I-1,J)+IA(I,J)+IA(I+1,J)
     @             +IA(I-1,J+1)+IA(I,J+1)+IA(I+1,J+1)
   10     CONTINUE
***
*C*                       *
*C*    0.111 = 1.0/9.0    *
