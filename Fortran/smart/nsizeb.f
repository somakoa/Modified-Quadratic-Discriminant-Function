      SUBROUTINE NSIZEB(IA,I1,J1,IL,IR,JT,JB,ILL)
CS    CALL NSIZEB(IA,I1,J1,IL,IR,JT,JB,ILL)
...
C*****
      ...
      DO 10 J=1,J1
          DO 20 I=1,I1
              IF(IA(I,J).EQ.1)GO TO 1000
   20     CONTINUE
   10 CONTINUE
C*****
C*    WRITE(6,600)
C 600 FORMAT(1H1,10X,'*** WARNING: ALL 0  ***')
      IL=0
      ILL=900
      RETURN
C*****
